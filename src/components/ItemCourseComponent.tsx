...
const ItemCourseComponent: React.FC = ()=>{
    return(
      ...
      <Card className="card-course-h overflow-hidden opacity-90 hover:opacity-100"
    hoverable
  ...
  >
    ...
    className="justify-start items-center text-left !py-3 text-avatar-course"
        ...
        <Button type="primary" className="bg-blue-600 hover:bg-blue-600 font-bold mt-3 max-sm:text-xs w-[100%] ">Buy Now</Button>
  </Card>
    </Col>
