                                                ...
                                                <div className="flex flex-col justify-center py-5">

                                                    {
                                                        datareview ? <>
                                                            ...
                                                            <Button onClick={() => { setshowmodalviewvd(true) }} className="mt-5 text-md bg-blue-600" type="primary">There are no reviews yet</Button>
                                                    }
                                                ...
                                                <div className="flex justify-start items-start space-x-2 border-b-2 py-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="truncate w-[370px] max-md:w-[170px] text-sm">{courses.headline}</p>
                                                        {
                                                            datareview?<>
                                                            {
                                                                rating != 0 ? <><Rate disabled defaultValue={rating} className="text-sm space-x-1"/></> :
